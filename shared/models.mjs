...
// Výběr aktualizován 15. 8. 2026, všechna ID ověřena proti OpenRouter API.
export const MODELS = [
  // --- OpenAI: řada GPT-5.6 (červenec 2026) ---
  { id: 'openai/gpt-5.6-sol', name: 'GPT-5.6 Sol', provider: 'OpenAI', tag: 'vlajkový', vision: true, description: 'Nejsilnější model OpenAI pro složité úlohy' },
  ...
  // Pozor: Fable 5 je drahý ($10/$50 za M tokenů) – s opakováním v Promptovači to naskakuje.
  { id: 'anthropic/claude-fable-5', name: 'Claude Fable 5', provider: 'Anthropic', tag: 'vlajkový', vision: true, description: 'Nejchytřejší model Anthropicu, třída Mythos (drahý)' },
  ...
  { id: 'google/gemini-3.7-flash', name: 'Gemini 3.7 Flash', provider: 'Google', tag: 'rychlý', vision: true, description: 'Nejnovější rychlý model Googlu (srpen 2026)' },

  // --- xAI ---
  // Grok 4.5 vracel v EU 403; 4.6 (10. 8. 2026) otestovat – při 403 vrátit x-ai/grok-4.3.
  ...
  { id: 'qwen/qwen3.8-max', name: 'Qwen 3.8-Max', provider: 'Alibaba', tag: 'čínský', vision: true, description: 'Vlajkový Qwen (srpen 2026), 1M kontext' },
